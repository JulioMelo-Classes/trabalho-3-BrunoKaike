...
25% não leva em conta o corpo da cobrinha
...
70% não foram feita compilação automatica

## Documentação do código / Readme / Documentação de Casos de Teste

**Avaliação**

80% parte da documentação do código está incompleta

## Atualizações do CP1

- atualizei render.snake/pacman 60%
- atualizei render.ui pra 50%
- atualizei render.snake para 30%
- atualizei logic.colisão comida/parede para 50%